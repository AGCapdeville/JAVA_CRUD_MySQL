...
public class App {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        ...
        try {
            ...
            String uid="root"; 
            String pass=""; 
            connection = DriverManager.getConnection("jdbc:mysql:///saleco_capdeville?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", uid, pass);
